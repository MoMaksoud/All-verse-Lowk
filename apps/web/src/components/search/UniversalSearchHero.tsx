      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <div className="mb-6 sm:mb-8">
            <div className="invisible inline-flex items-center gap-1.5 sm:gap-2 bg-accent-500/10 border border-accent-500/20 rounded-full px-3 py-1.5 sm:px-4 sm:py-2 mb-4 sm:mb-6 backdrop-blur-sm text-xs sm:text-sm">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 sm:mb-6 text-gradient drop-shadow-lg px-2 break-words">
              Find Anything, Anywhere
            </h1>
            <p className="text-md md:text-lg lg:text-xl mb-6 sm:mb-8 text-white max-w-3xl mx-auto drop-shadow-lg px-4" style={{ textShadow: '0 2px 4px rgba(0, 0, 0, 0.5)' }}>
          ...
          <form onSubmit={handleSubmit} className="relative max-w-2xl mx-auto">
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-accent-500/20 to-primary-500/20 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-200" />
              <div className="relative flex items-center bg-white/10 backdrop-blur-xl border-2 border-white/20 rounded-2xl overflow-hidden shadow-2xl hover:border-accent-500/50 transition-all duration-200 min-h-12 sm:min-h-14">
            ...
            <div className="mt-4 sm:mt-3 flex justify-center">
              <button
                type="button"
                onClick={() => setShowImageModal(true)}
                className="hidden inline-flex items-center justify-center gap-2 px-4 py-3 min-h-[44px] sm:py-2 bg-white/5 hover:bg-white/10 backdrop-blur-sm border border-white/10 rounded-full text-white/90 text-sm transition-all duration-200"
              >
