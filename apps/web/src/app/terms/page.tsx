          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                Welcome to All Verse LLC (the "App"), an AI-powered marketplace and social hub. By accessing or using the App, you agree to comply with and be bound by these Terms and Conditions ("Terms"). If you do not agree with any part of these Terms, please refrain from using the App.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. You agree to notify All Verse LLC immediately of any unauthorized use of your account or any other breach of security.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                You are solely responsible for the Content you post, upload, or otherwise make available through the App. By doing so, you represent and warrant that you own or have the necessary licenses, rights, consents, and permissions to use and authorize All Verse LLC to use such Content.
              </p>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">6.2 License Grant</h3>
              <p className="text-gray-300 leading-relaxed">
                By posting Content on the App, you grant All Verse LLC a worldwide, non-exclusive, royalty-free, transferable, sub-licensable license to use, reproduce, distribute, prepare derivative works of, display, and perform the Content in connection with the App and All Verse LLC's business.
              </p>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">6.3 Monitoring and Removal</h3>
              <p className="text-gray-300 leading-relaxed">
                All Verse LLC reserves the right, but is not obligated, to monitor, edit, or remove any Content that violates these Terms or is otherwise objectionable.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                When purchasing an item or service through the App, you agree to pay all charges associated with the transaction, including any applicable taxes and fees. All Verse LLC is not responsible for the quality, safety, legality, or delivery of the items or services sold by users.
              </p>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">7.3 Disputes</h3>
              <p className="text-gray-300 leading-relaxed">
                Any disputes arising from marketplace transactions are solely between the buyer and seller. All Verse LLC may, at its discretion, assist in resolving disputes but has no obligation to do so.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                The App may provide content generated by artificial intelligence ("AI"). While All Verse LLC strives for accuracy, AI-generated content may not always be accurate or reliable. You acknowledge and agree that any reliance on AI-generated content is at your own risk.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                Your use of the App is subject to All Verse LLC's Privacy Policy, which outlines how we collect, use, and protect your personal information. By using the App, you consent to the collection and use of your information as described in the Privacy Policy.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                All Verse LLC and its licensors own all rights, title, and interest in and to the App, including all associated intellectual property rights. These Terms do not grant you any rights to use any trademarks, logos, or service marks displayed on the App.
              </p>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">10.2 User Content</h3>
              <p className="text-gray-300 leading-relaxed">
                You retain ownership of any intellectual property rights that you hold in the Content you post on the App. By posting Content, you grant All Verse LLC the rights described in Section 6.2 of these Terms.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                The App and all Content and Services provided through it are provided on an "as is" and "as available" basis without any warranties of any kind, either express or implied. All Verse LLC disclaims all warranties, express or implied, including but not limited to implied warranties of merchantability, fitness for a particular purpose, and non-infringement.
              </p>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">11.2 No Liability for User Conduct</h3>
              <p className="text-gray-300 leading-relaxed">
                All Verse LLC is not responsible or liable for the conduct of any user or for any Content posted by users. You assume all risk when using the App and interacting with other users.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                To the fullest extent permitted by applicable law, All Verse LLC shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses, resulting from: • Your access to or use of or inability to access or use the App. • Any conduct or Content of any third party on the App. • Any Content obtained from the App. • Unauthorized access, use, or alteration of your transmissions or Content.
              </p>
            </section>
            ...
            <div className="mt-12 pt-6 border-t border-white/10">
              <p className="text-gray-400 text-sm text-center">
                By using All Verse, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.
              </p>
            </div>
          </div>
        </div>
